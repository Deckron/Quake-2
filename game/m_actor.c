...
// check for gib
	if (self->health <= 0)//david villa mod change, was -80
	{
//		gi.sound (self, CHAN_VOICE, actor.sound_gib, 1, ATTN_NORM, 0);
		for (n= 0; n < 2; n++)
			ThrowGib (self, "models/objects/gibs/bone/tris.md2", damage, GIB_ORGANIC);
			//ThrowGib(self, "models/objects/gibs/bone/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
		for (n= 0; n < 4; n++)
			ThrowGib (self, "models/objects/gibs/sm_meat/tris.md2", damage, GIB_ORGANIC);
			//ThrowGib(self, "models/objects/gibs/sm_meat/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
		ThrowHead(self, "models/objects/gibs/head2/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
		ThrowHead(self, "models/objects/gibs/head2/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
		ThrowHead(self, "models/objects/gibs/head2/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
		ThrowHead(self, "models/objects/gibs/head2/tris.md2", damage, GIB_ORGANIC);//david villa mod addition
